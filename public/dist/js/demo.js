...
$(function () {
    ...
    $('#invoice_edit_submit').click(function(){
        document.getElementById("invoice_edit_form").submit();
    });

    $('#invoice_add_submit').click(function(){
        document.getElementById("invoice_add_form").submit();
    });

    $('#supplier_edit_submit').click(function(){
        document.getElementById("supplier_edit_form").submit();
    });

    $('#invoice_add_form').bootstrapValidator({
    ...
    $('#invoice_edit_form').bootstrapValidator({
        message: 'This value is not valid',
        feedbackIcons: {
            valid: 'glyphicon glyphicon-ok',
            invalid: 'glyphicon glyphicon-remove',
    ...
    $('#supplier_edit_form').bootstrapValidator({
        message: 'This value is not valid',
        feedbackIcons: {
            valid: 'glyphicon glyphicon-ok',
            invalid: 'glyphicon glyphicon-remove',
